...
<form name="form" id="form" method="post" action="admin_save.php" onsubmit="return cfm_admin();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
		  ...
		  <td><select name="live_prov" style="width:115px;" class="input" id="live_prov" onchange="SelProv(this.value,'live');">
	      ...
	      &nbsp;&nbsp;城市：
	      <select style="width:115px;" class="input" name="live_city" id="live_city" onchange="SelCity(this.value,'live');">
		...
		<tr>
		  ...
		  <td><input type="text" name="phone" class="input" id="phone" />
	      <span class="maroon">*</span></td>
	  </tr>
		<tr>
			<td height="40" align="right">管理组：</td>
			<td><select name="levelname" id="levelname" class="input" style="width:285px;">
				<?php
