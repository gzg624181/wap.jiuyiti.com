		...
		<tr>
			...
			?>
				...
				<div class="purviewList"> <span>
					...
					数据库备份</span></div>
				<div class="purviewTitle"><strong>商品信息</strong></div>
				<div class="purviewList"> <span>
				...
				<div class="purviewTitle"><strong>会员管理</strong></div>
				<div class="purviewList"> <span>
					...
					新增会员</span></div>
				<div class="purviewTitle"><strong>订单管理</strong></div>
				<div class="purviewList"> <span>
					...
					商品信息属性</span>--></div>
				<div class="purviewTitle"><strong>商户账号</strong></div>
				<div class="purviewList"> <span>
