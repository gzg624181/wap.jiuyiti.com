...
<title>商户订单折扣比例</title>
<link href="templates/style/admin.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="templates/js/jquery.min.js"></script>
<script type="text/javascript" src="templates/js/forms.func.js"></script>
</head>
<body>
<div class="topToolbar"> <span class="title">折扣比例管理</span> <a href="javascript:location.reload();" class="reload">刷新</a></div>
<form name="form" id="form" method="post" action="order_save.php?action=savediscout">
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="dataTable">
		<tr align="left" class="head">
			...
			<td width="17%">规则简介</td>
			<td width="17%">折扣起始金额</td>
			<td width="17%">折扣截止金额</td>
			<td width="17%" align="center">优惠比例</td>
			<td width="17%" align="center">折扣比例</td>
			<td width="8%" align="center">排序</td>
			<td width="4%" class="endCol">操作</td>
		</tr>
		<?php
		$dosql->Execute("SELECT * FROM `#@__discout` ORDER BY `orderid` ASC");
		...
		<tr align="left" class="dataTr">
			...
			<td class="action endCol"><a href="active_save.php?action=del5&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a></td>
		</tr>
		<?php
			}
		}
...
<div class="bottomToolbar"><span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:DelAllNone('active_save.php');" onclick="return ConfDelAll(0);">删除</a>　<span>操作：</span><a href="javascript:UpOrderID('active_save.php');">更新排序</a></span> <a href="#" onclick="form.submit();" class="dataBtn">更新全部</a></div>
<div class="page">
