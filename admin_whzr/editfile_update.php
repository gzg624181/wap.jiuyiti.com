...
if($action == 'update')
{
	if($cfg_editfile == 'Y')
	{
		...
		echo "<script language=javascript>alert('文件保存成功！');history.back();</script>";
		exit();
	}
	else
	{
...
<form name="form" id="form" method="post" action="?action=update&filename=<?php echo urlencode($filename); ?>">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr align="center">
			<td height="40">文件名称：<strong><span style="font-family: Verdana, Geneva, sans-serif;
				 border-radius:3px;"><?php echo $gbfilename; ?></span></strong></td>
		</tr>
		<tr align="center">
...
<div class="bottomToolbar"> <a href="#" onclick="form.submit();" class="dataBtn">保存文件</a>
<a style="cursor:pointer" onclick="history.go(-1);" class="dataBack">返回文件</a>
<a style="cursor:pointer" href="upload_filemgr_api_dir.php" class="dataBack">返回API列表</a>
</div>
</body>
</html>
