...
$gourl  = 'erweima.php?Commercial='.$Commercial;
...
$erweima= save_erweima(get_access_token($appid,$secret),$xiaochengxu_path,$save_path,$url);
	$sql = "UPDATE $tbname SET bilv='$bilv',erweima='$erweima' where Commercial='$Commercial'";
...
else if($action == 'update')
{
	...
	$sql = "UPDATE $tbname SET bilv='$bilv' where Commercial='$Commercial'";
