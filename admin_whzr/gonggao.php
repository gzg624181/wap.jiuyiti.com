...
<body>
<div class="formHeader"> <span class="title">公告说明</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<?php
$r=$dosql->GetOne("select * from shuoming where id=2");
?>
<form name="form" id="form" method="post" action="shuoming_save.php" onsubmit="return cfm_sm();">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			<td width="7%" height="40" align="right">公告标题：</td>
			<td width="93%"><input type="text" name="title" id="title" value="<?php echo $r['title'];?>" class="input"/></td>
		</tr>
		<tr>
		  <td height="345" align="right">公告说明：</td>
	...
	<div class="formSubBtn" style="float:left; margin-left:115px;">
		...
		<input type="hidden" name="action" id="action" value="update_gonggao" />
