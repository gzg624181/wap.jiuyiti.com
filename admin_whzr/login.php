...
<div class="loginTop" <?php echo GetLoginBg(); ?>>
    ...
    <span class="note">
		...
		<?php if($cfg_author != '') echo '<i>Author : '.$cfg_author.'</i>'; ?>
		</div>
</div>
<div class="loginWarp">
	<div class="loginArea">
		<div class="loginHead"> </div>
		<div class="loginTxt">酒易提登录管理中心</div>
		<div class="loginForm">
			...
			<div class="loginThanks">技术支持：<span>武汉众睿科技</span></div>
		</div>
	</div>
</div>
<div class="loginCopyright">© 2017 <?php echo $cfg_webname;?></div>
</body>
</html>
