	...
	$("#SaveBtn").click(function(){
		...
		if(<?php echo $num ;?> > 1)
		{
			...
			$("li.img").each(function(i){
				fileurl_tmp += '<li rel="'+ fileurl_val[i] +'"><input type="hidden" name="<?php echo $input; ?>[]" value="'+ fileurl_val[i] +'" /><img src="../'+ fileurl_val[i] +'" width="100" height="120" ><a href="javascript:void(0);" onclick="ClearPicArr(\''+ fileurl_val[i] +'\')">删除</a><br /><input type="text" name="<?php echo $input; ?>_txt[]" value="' + filetxt_val[i] +'" /></li>';
			});
