...
<body>
<div class="topToolbar"> <span class="title">会员推荐码：</span><span class="num" style="color:red;"><?php echo $Recommand;?></span> <a title="刷新" href="javascript:location.reload();" class="reload"><i class="fa fa-refresh" aria-hidden="true"></i></a></div>
<form name="form" id="form" method="post" action="product_save.php">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dataTable">
		<tr align="center" class="head">
			...
			<td width="20%" align="center">购买金额</td>
			<td width="15%" align="center">提现比率</td>
			<td width="18%" align="center">提现金额</td>
		  <td width="19%" align="center">购买时间</td>
		</tr>
		<?php
		$jiuqian_la=0;
		$dopage->GetPage("SELECT a.bilv as bl,a.sum_money,a.posttime,a.account,a.money,b.Alias FROM `recommandlist` a inner join memberuser b on a.account=b.Phone where a.tjm='$Recommand' and a.type=0",10);	
		...
		<tr align="left" class="dataTr">
			...
			<td align="center"><span class="number"><?php echo $row['posttime']; ?></span>
            </td>
		</tr>
		<?php
		}
