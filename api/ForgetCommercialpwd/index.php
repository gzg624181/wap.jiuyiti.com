<?php
    /**  
	 * 链接地址：ForgetCommercialpwd   修改商户登陆密码
	 *
     ...
     * @return string
     *           
     * @会员注册账号 提供返回参数账号，  手机号码 Phone 验证码，captcha  password
	   (获取忘记密码的短信验证码GetSmsVerify接口)
     */
...
$secs = strtotime($Version)-strtotime($start_time);
 ...
 if($content==$captcha && $num<15 && $secs <180 )	{ 
	...
	$sql = "UPDATE `commercialuser` SET Password='$pwd' where Account='$Phone'";
