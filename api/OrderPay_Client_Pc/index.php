<?php
     ...
     *
     * @删除购物车 提供返回参数账号  payamount 现金支付  jiuqian 酒钱 订单号orderid
...
$Version=date("Y-m-d H:i:s");
 ...
 if(floatval($payamount)==0){    //酒钱支付
  ...
  //添加完订单表，商品订单表之后，目前订单的类型全部是快递订单2
   ...
   //更新订单的预约状态,付款状态，支付状态
$sql ="UPDATE `orderform_commercial` SET PayAmount='$payamount', PaymentType='$paymenttype',PayJiuQian='$jiuqian',paytype='$paytype',dingdantype=2,State=1 WHERE OrderId='$orderid'";
