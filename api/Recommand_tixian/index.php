...
$recommand=$r['Recommand'];
  $dosql->Execute("SELECT * FROM `recommandlist` a inner join memberuser b on a.account=b.Phone where a.tjm='$recommand' and a.type=0 order by a.posttime desc");
