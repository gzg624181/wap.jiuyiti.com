            <div class="col-md-3">
                <div class="row">
					...
					<div class="met-news-bar">
                        ...
                        <form method="post" action="caselist-16-1.html">
				...
				$dosql->Execute("SELECT * FROM `#@__infoimg` WHERE (classid=$cid OR parentstr LIKE '%,$cid,%') AND delstate='' AND checkinfo=true and flag like '%c%' ORDER BY orderid DESC limit 6");
